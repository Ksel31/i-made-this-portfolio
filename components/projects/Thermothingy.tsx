...
export default function Thermothingy() {
  return (
    <>
      {/* HERO */}
      <section id="thermothingy" className="sticky top-0 relative h-screen overflow-hidden flex flex-col justify-end z-0">
        ...
        <div className="relative z-10 max-w-[1400px] w-full mx-auto px-8 pb-14 grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {['Terminé', 'ESP32', 'Arduino C++', 'SolidWorks', 'FDM PLA'].map(tag => (
          ...
          <div className="flex flex-col md:items-end gap-3">
            ...
            <p className="text-white/50 text-sm leading-relaxed md:text-right max-w-sm">
              ESP32-C3, DHT22, écran 1.69" IPS, boîtier imprimé en 3D, firmware Arduino C++ et intégration Home Assistant via MQTT.
            </p>
          </div>
        </div>
      </section>
