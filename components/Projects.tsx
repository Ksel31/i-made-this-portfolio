...
const projects = [
  {
    ...
    index: '01 / 02',
    title: 'PiNAS\nTHINGY.',
    hook: "J'avais besoin d'un NAS. J'aurais pu acheter un Synology. J'ai modélisé un boîtier à la place.",
    desc: "Conçu pour le stack Raspberry Pi 5 + Geekworm X1005 dual NVMe. Modélisé dans SolidWorks au millimètre, rendu dans Blender parce que pourquoi pas.",
  ...
  },
  {
    ...
    index: '02 / 02',
    title: 'THERMO\nTHINGY.',
    hook: "J'avais un ESP32 et un DHT22. Juste pour voir. Et une chose en entraînant une autre.",
    desc: "Thermomètre/hygromètre ambiant avec écran 1.69\" IPS en temps réel. Enclosure SolidWorks, imprimée sur une Ender 3 Pro pas encore domptée.",
