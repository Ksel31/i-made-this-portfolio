...
const projects = [
  {
    ...
    index: '01 / 02',
    title: 'PiNAS\nTHINGY.',
    hook: "Il me fallait un NAS, alors je l'ai fait. Parce que c'était plus fun que d'en acheter un, et que j'avais les pièces qui traînaient pour le faire.",
    desc: "Conçu pour le stack Raspberry Pi 5 + Geekworm X1005 dual NVMe. Modélisé dans SolidWorks, les rendus sont fait dans Blender.",
  ...
  },
  {
    ...
    desc: "Thermomètre/hygromètre ambiant avec écran 1.69\" IPS en temps réel. Modélisé dans SolidWorks, les rendus sont fait dans Blender. Le tout propulsé par un ESP32-C3 avec un capteur DHT22, les données sont envoyées à Home Assistant via Wifi et MQTT.",
